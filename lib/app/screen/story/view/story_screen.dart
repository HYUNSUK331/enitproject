        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: Obx(() => controller.storyList[controller.storyIndex].isLike?
              IconButton(
                  onPressed: () => {
                    controller.updateUnLike('${controller.storyList[controller.storyIndex].storyPlayListKey}', controller.storyIndex)
                  },
                  icon: const Icon(
                    Icons.favorite,
              ...
              IconButton(
                  onPressed: ()=>{
                    controller.updateLike('${controller.storyList[controller.storyIndex].storyPlayListKey}',controller.storyIndex)
                  },
                  icon: const Icon(
        ...
        body: Stack(
          children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                      ...
                      child: Column(
                        children: [
                          Text(
                            ...
                            '${controller.storyList[controller.storyIndex].title}',
                            style: TextStyle(
                              fontSize: 40.0,
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                '${controller.storyList[controller.storyIndex].addressDetail}',
                                style: TextStyle(
                                    fontSize: 16.0,
                    ...
                    Image.network(
                      '${controller.storyList[controller.storyIndex].image}',
                    ...
                    CircleAvatar(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () async{
                          controller.updatePlay(controller.storyIndex);
                        },
                      )
                    ),
                    SizedBox(height: 20.0,),
                    Container(
                      child: Text(
                        '${controller.storyList[controller.storyIndex].script}',
                        style: TextStyle(
                            fontSize: 15.0
                        ),
                      ),
            ...
            Positioned(
                ...
                child: BottomPopupPlayer(storyIndex: controller.storyIndex,)
            ) :
            SizedBox.shrink()),
          ]
        ),
